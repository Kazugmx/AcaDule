...
class TaskService(@Suppress("unused") database: Database) {
    ...
    suspend fun createTask(task: CreateTaskReq, reqOwnerID: Int) = dbQuery {
        TasksTable.insert {
    ...
    suspend fun getTaskByID(taskID: String, userID: Int?): TaskRes? = dbQuery {
        TasksTable.select(
            TasksTable.id,
            TasksTable.title,
            TasksTable.description,
    ...
    suspend fun updateTask(task: UpdateTaskReq, userID: Int) = dbQuery {
        TasksTable.update(
    ...
    suspend fun deleteTask(id: String, userID: Int) = dbQuery {
